...
public class App {
    ...
    static List<Flyable> flyableVehicles = new ArrayList<>();

    /* List of Moveable model */
    static List<Moveable> moveableVehicles = new ArrayList<>();

    /* List of Swimable model */
    static List<Swimable> swimableVehicles = new ArrayList<>();
